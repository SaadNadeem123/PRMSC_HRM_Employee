...
import com.lmkr.prmscemployeeapp.databinding.RecyclerItemLeaveManagementBinding;
...
public class LeaveManagementRecyclerAdapter extends RecyclerView.Adapter<LeaveManagementRecyclerAdapter.ViewHolder> {
    ...
    private List<LeaveManagementModel> leaveManagement;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String totaldays = leaveManagementModel.getTotal_days()+" "+(leaveManagementModel.getTotal_days()>1?context.getString(R.string.days):context.getString(R.string.day));
