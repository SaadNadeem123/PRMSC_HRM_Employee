...
import com.lmkr.prmscemployeeapp.databinding.FragmentTimeoffBinding;
...
public class TimeoffFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        TimeoffViewModel timeoffViewModel =
                new ViewModelProvider(this).get(TimeoffViewModel.class);

        binding = FragmentTimeoffBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textDashboard;
        timeoffViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
